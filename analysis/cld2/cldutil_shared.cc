...
// 1-, 2-, or 3-bytes each.
static const uint32_t kPreSpaceIndicator =  0x00004444;
static const uint32_t kPostSpaceIndicator = 0x44440000;

// Little-endian masks for 0..24 bytes picked up as uint32_t's
static const uint32_t kWordMask0[4] = {
