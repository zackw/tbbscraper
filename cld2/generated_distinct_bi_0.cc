...
static const uint32_t kDistinctBiTableBuildDate = 20130101;    // yyyymmdd
static const uint32_t kDistinctBiTableSize = 1;       // Total Bucket count
static const uint32_t kDistinctBiTableKeyMask = 0xffffffff;    // Mask hash key
