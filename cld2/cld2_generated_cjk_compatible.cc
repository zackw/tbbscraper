...
static const uint32_t kCompatTableBuildDate = 20130128;    // yyyymmdd
static const uint32_t kCompatTableSize = 1;          // Total Bucket count
static const uint32_t kCompatTableKeyMask = 0xffffff00;    // Mask hash key
...
static const uint32_t kCompatTableSizeOne = 0;           // One-langprob count
static const uint32_t kCompatTableIndSize = 239 * 2;     // Largest subscript
static const uint32_t kCompatTableInd[kCompatTableIndSize] = {
  // [0000]
